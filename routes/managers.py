...
managers_bp.add_url_rule('/managers/make_staff/<int:id>',view_func=make_staff,methods=['GET','POST'])
managers_bp.add_url_rule('/managers/remove_staff/<int:id>',view_func=remove_staff,methods=['GET','POST'])
